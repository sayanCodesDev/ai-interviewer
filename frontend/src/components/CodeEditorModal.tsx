...
import { X, Play, Code2, Check, Minimize2, Maximize2, Loader2, Timer } from "lucide-react";
...
export function CodeEditorModal({
    ...
    }, [initialLanguage, questionPrompt]);
    ...
    return (
        <div className={`h-full transition-all duration-300 transform ease-in-out ${
            isMinimized ? "w-80 h-16 fixed bottom-6 right-6 z-50" : "w-full h-full flex flex-col"
        }`}>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {!isMinimized && (
                            <select
                                ...
                                className="bg-slate-800 text-xs text-slate-200 border border-slate-700 rounded-lg px-2.5 py-1 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                            >
                        ...
                        <button
                            ...
                            className="p-1.5 text-slate-400 hover:text-slate-200 rounded-lg hover:bg-slate-800/80 transition-colors"
